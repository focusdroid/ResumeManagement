...
type Backlog struct {
	...
	BacklogType   int    `gorm:"column:backlog_type;type:tinyint;not null;default:0" db:"column:backlog_type" form:"backlog_type" json:"backlog_type" comment:"是待办还是便签1待办2是便签"`
